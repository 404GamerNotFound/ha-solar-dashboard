...
- Im visuellen Editor können unter Batterie 1 weitere Batterien ergänzt werden. Jede zusätzliche Batterie unterstützt eigene Entitäten für SoC, signierten Leistungsfluss oder getrennte Lade-/Entladeleistung, Spannung, Min-/Max-SoC, Temperatur und Tageszyklen. Der Kachel-SoC wird aus allen verfügbaren SoC-Sensoren gemittelt; die Leistungsflüsse werden vorzeichenrichtig saldiert. Bestehende Konfigurationen bleiben als Batterie 1 vollständig kompatibel.
